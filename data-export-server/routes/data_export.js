...
var exportDataMng = {
	...
	exportData: function (req, res) {
		...
		if(req.body.table == 'ip'){
			...
			exec('/opt/Rajnish/Script/ExportDataFromBigQuery.sh  -dataset DevDiggit_Hist -query "SELECT * FROM DevDiggit_Hist.ip_aggregation limit 22000"  -download_local -local_path /opt/jeevan/', function(err, out, code) {
