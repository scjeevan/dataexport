...
DATAEXPORT_FTP_HOST='146.148.110.133'
DATAEXPORT_FTP_PORT=22
DATAEXPORT_FTP_LOCATION=/home/
...
export DATAEXPORT_CLIENT_PORT DATAEXPORT_SERVER_PORT DATAEXPORT_MYSQL_HOST DATAEXPORT_MYSQL_USER DATAEXPORT_MYSQL_PASSWORD DATAEXPORT_MYSQL_DBNAME DATAEXPORT_CSV_SAVE_PATH DATAEXPORT_FTP_LOCATION DATAEXPORT_GQ_PROJECT_ID DATAEXPORT_GQ_KEY_PATH DATAEXPORT_GQ_SCRIPT_PATH